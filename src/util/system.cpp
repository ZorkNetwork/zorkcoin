...
const char * const BITCOIN_CONF_FILENAME = "zorkcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Zorkcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Zorkcoin";
#else
    // Unix-like
    return pathRet / ".zorkcoin";
#endif
#endif
}

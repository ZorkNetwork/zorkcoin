 ...
 */
static constexpr int64_t MAX_FUTURE_BLOCK_TIME = 2 * 60 * 60 * 1000; // MILLISECOND_TIMESTAMP:
 ...
 */
static constexpr int64_t MAX_BLOCK_TIME_GAP = 90 * 60 * 1000; // MILLISECOND_TIMESTAMP:

...
<context>
    ...
    <message>
        ...
        <translation>Это ваши зорккоин-адреса для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation>Это ваши зорккоин адреса для получения платежей. Используйте кнопку «Создать новый адрес для получения» на вкладке Получить, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation>Предупреждение: Если вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ зорккоинЫ&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Помните, что шифрование вашего кошелька не может полностью защитить ваши зорккоины от кражи вредоносными программами, заражающими ваш компьютер.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Послать средства на зорккоин-адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения зорккоин-адресами, чтобы подтвердить, что это написали именно вы</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Zorkcoin addresses</source>
        <translation>Проверяйте сообщения, чтобы убедиться, что они подписаны конкретными зорккоин-адресами</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети Zorkcoin</numerusform><numerusform>%n активных подключения к сети Zorkcoin</numerusform><numerusform>%n активных подключений к сети Zorkcoin</numerusform><numerusform>%n активных подключений к сети зорккоин</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Загрузить Частично Подписанные зорккоин Транзакции (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть зорккоин: URI</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным зорккоин-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Zork Network Node</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть URI зорккоина</translation>
    </message>
    <message>
        <source>URI:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для зорккоин-клиента на маршрутизаторе. Работает, если ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключиться к сети зорккоин через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к зорккоин-сети через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью зорккоин после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить зорккоин: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'zorkcoin://' неверный URI. Используйте 'zorkcoin:' вместо этого.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать идентификатор! Это может быть связано с неверным зорккоин-адресом или неправильными параметрами идентификатора.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите зорккоин-адрес (напр. %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть зорккоин.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Создает Частично Подписанную зорккоин Транзакцию (PSBT), чтобы использовать её, например, с оффлайн %1 кошельком, или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пожалуйста, пересмотрите ваше транзакционное предложение. Это создаст Частично Подписанную зорккоин Транзакцию (PSBT), которую можно сохранить или копировать и использовать для подписи, например, с оффлайн %1 кошельком, или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Предупреждение: Неверный зорккоин-адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>зорккоин-адрес, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>С отправляемой суммы будет удержана комиссия. Получателю придёт меньше зорккоинов, чем вы вводите в поле количества. Если выбрано несколько получателей, комиссия распределяется поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сообщение, прикрепленное к зорккоин-идентификатору, будет сохранено вместе с транзакцией для вашего сведения. Заметьте: Сообщение не будет отправлено через сеть зорккоин.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения/соглашения своими адресами, чтобы доказать свою возможность получать зорккоины на них. Будьте осторожны, не подписывайте что-то неопределённое или случайное, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The Zorkcoin address to sign the message with</source>
        <translation>зорккоин-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать предыдущий использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение зорккоин-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>зорккоин-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным зорккоин-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>%s испорчен. Попробуйте восстановить с помощью инструмента zorkcoin-wallet, или используйте резервную копию.</translation>
    </message>
    <message>

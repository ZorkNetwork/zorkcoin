...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zorkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zorkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded zorkcoin transaction\n" +
            "or:     zorkcoin-tx [options] -create [commands]   Create hex-encoded zorkcoin transaction\n" +
            "\n";

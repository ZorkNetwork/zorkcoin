...
{
    BOOST_CHECK_EQUAL(FormatISO8601DateTime(1317425777*1000), "2011-09-30T23:36:17Z");
    BOOST_CHECK_EQUAL(FormatISO8601DateTime(0), "1970-01-01T00:00:00Z");

    BOOST_CHECK_EQUAL(ParseISO8601DateTime("1970-01-01T00:00:00Z"), 0);
    BOOST_CHECK_EQUAL(ParseISO8601DateTime("1960-01-01T00:00:00Z"), 0);
    BOOST_CHECK_EQUAL(ParseISO8601DateTime("2011-09-30T23:36:17Z"), 1317425777*1000);

    auto time = GetSystemTimeInSeconds();
    BOOST_CHECK_EQUAL(ParseISO8601DateTime(FormatISO8601DateTime(time*1000)), time*1000);
}

BOOST_AUTO_TEST_CASE(util_FormatISO8601Date)
{
    BOOST_CHECK_EQUAL(FormatISO8601Date(1317425777*1000), "2011-09-30");
}
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    ...
    const std::string expected_signature =
        "HxaNASajrGXjw7jXIPFsTWR4kmM8GYoxepiwKP5txUD3VMqMYQkbYO5lC4C7bXQGL3XCgRxK8FrxFXmGP0dntx8=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "ZN77eWdmfXTfjPj1qSSCo41zCYeak3wUQw",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "ZS4GuYrshn2pw4dRVJTFTrcCURM6cRwFWe",
            "HxaNASajrGXjw7jXIPFsTWR4kmM8GYoxepiwKP5txUD3VMqMYQkbYO5lC4C7bXQGL3XCgRxK8FrxFXmGP0dntx8=",
            "I never signed this"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "ZS4GuYrshn2pw4dRVJTFTrcCURM6cRwFWe",
            "H8kkaqYjzxS4C2/uXeMiykwrqexXySZH7iEcpWdpX1ixMv13yt9eHlKSZB4bbwekq88kjujbaQLtoHm7F8AbAcg=",
            "Trust me"),
        MessageVerificationResult::OK);
}

...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    Check("combo(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "combo(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", SIGNABLE, {{"2102a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cac","76a9140c13eca58177d726d65b8556f351d081b1103bf088ac","00140c13eca58177d726d65b8556f351d081b1103bf0","a9147bdb0f7aa46efb97e699cef65234d80481fab37287"}}, nullopt);
    Check("pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", SIGNABLE, {{"2102a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cac"}}, nullopt);
    Check("pkh([deadbeef/1/2'/3/4']RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "pkh([deadbeef/1/2'/3/4']02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", SIGNABLE, {{"76a9140c13eca58177d726d65b8556f351d081b1103bf088ac"}}, OutputType::LEGACY, {{1,0x80000002UL,3,0x80000004UL}});
    Check("wpkh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "wpkh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", SIGNABLE, {{"00140c13eca58177d726d65b8556f351d081b1103bf0"}}, OutputType::BECH32);
    Check("sh(wpkh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "sh(wpkh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", SIGNABLE, {{"a9147bdb0f7aa46efb97e699cef65234d80481fab37287"}}, OutputType::P2SH_SEGWIT);
    ...
    CheckUnparsable("pkh(deadbeef/1/2'/3/4']RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "pkh(deadbeef/1/2'/3/4']02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", "Key origin start '[ character expected but not found, got 'd' instead"); // Missing start bracket in key origin
    CheckUnparsable("pkh([deadbeef]/1/2'/3/4']RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "pkh([deadbeef]/1/2'/3/4']02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", "Multiple ']' characters found for a single pubkey"); // Multiple end brackets in key origin
    
    // Basic single-key uncompressed
    Check("combo(6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "combo(04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", SIGNABLE, {{"4104a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762ac","76a91419c13841a49884bd124fed9f4e036ec2462403fd88ac"}}, nullopt);
    Check("pk(6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "pk(04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", SIGNABLE, {{"4104a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762ac"}}, nullopt);
    Check("pkh(6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "pkh(04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", SIGNABLE, {{"76a91419c13841a49884bd124fed9f4e036ec2462403fd88ac"}}, OutputType::LEGACY);
    CheckUnparsable("wpkh(6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "wpkh(04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", "Uncompressed keys are not allowed"); // No uncompressed keys in witness
    CheckUnparsable("wsh(pk(6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8))", "wsh(pk(04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762))", "Uncompressed keys are not allowed"); // No uncompressed keys in witness
    CheckUnparsable("sh(wpkh(6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8))", "sh(wpkh(04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762))", "Uncompressed keys are not allowed"); // No uncompressed keys in witness
    
    // Some unconventional single-key constructions
    Check("sh(pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "sh(pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", SIGNABLE, {{"a914de92af19990cd11b293afd89b9d1985fa0b8166f87"}}, OutputType::LEGACY);
    Check("sh(pkh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "sh(pkh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", SIGNABLE, {{"a91401c62701a59dea1cf6d8b834a994f77575df782487"}}, OutputType::LEGACY);
    Check("wsh(pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "wsh(pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", SIGNABLE, {{"0020f971e2b302ee0977ddb08d4150e50acabda3f53478fbd474a866b616ce041868"}}, OutputType::BECH32);
    Check("wsh(pkh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "wsh(pkh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", SIGNABLE, {{"002099dba00720686a1275aae85494e4eafc1744ba11d4eb6059e83e383e49fe7274"}}, OutputType::BECH32);
    Check("sh(wsh(pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)))", "sh(wsh(pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)))", SIGNABLE, {{"a914bd45baff235b772370d6265d268b1ddb08917b0e87"}}, OutputType::P2SH_SEGWIT);
    Check("sh(wsh(pkh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)))", "sh(wsh(pkh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)))", SIGNABLE, {{"a914c36470aa22c4026cf75d377d3611f86225f7676c87"}}, OutputType::P2SH_SEGWIT);
    ...
    Check("multi(1,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT,6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "multi(1,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c,04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", SIGNABLE, {{"512102a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c4104a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c176252ae"}}, nullopt);
    Check("sortedmulti(1,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT,6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "sortedmulti(1,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c,04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", SIGNABLE, {{"512102a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c4104a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c176252ae"}}, nullopt);
    Check("sortedmulti(1,6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "sortedmulti(1,04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", SIGNABLE, {{"512102a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c4104a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c176252ae"}}, nullopt);
    ...
    CheckUnparsable("multi(a,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT,6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "multi(a,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c,04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", "Multi threshold 'a' is not valid"); // Invalid threshold
    CheckUnparsable("multi(0,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT,6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "multi(0,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c,04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", "Multisig threshold cannot be 0, must be at least 1"); // Threshold of 0
    CheckUnparsable("multi(3,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT,6c2CsFoqCHdRKKThiSBxkmexpARXyC24urDanw3JLJYA56WzZN8)", "multi(3,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c,04a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8cf2858b37e9ef7162964cfaf304f859350af59745166f1a9345916c7ba43c1762)", "Multisig threshold cannot be larger than the number of keys; threshold is 3 but only 2 keys specified"); // Threshold larger than number of keys
    ...
    CheckUnparsable("sh(multi(16,KzoAz5CanayRKex3fSLQ2BwJpN7U52gZvxMyk78nDMHuqrUxuSJy,KwGNz6YCCQtYvFzMtrC6D3tKTKdBBboMrLTsjr2NYVBwapCkn7Mr,KxogYhiNfwxuswvXV66eFyKcCpm7dZ7TqHVqujHAVUjJxyivxQ9X,L2BUNduTSyZwZjwNHynQTF14mv2uz2NRq5n5sYWTb4FkkmqgEE9f,L1okJGHGn1kFjdXHKxXjwVVtmCMR2JA5QsbKCSpSb7ReQjezKeoD,KxDCNSST75HFPaW5QKpzHtAyaCQC7p9Vo3FYfi2u4dXD1vgMiboK,L5edQjFtnkcf5UWURn6UuuoFrabgDQUHdheKCziwN42aLwS3KizU,KzF8UWFcEC7BYTq8Go1xVimMkDmyNYVmXV5PV7RuDicvAocoPB8i,L3nHUboKG2w4VSJ5jYZ5CBM97oeK6YuKvfZxrefdShECcjEYKMWZ,KyjHo36dWkYhimKmVVmQTq3gERv3pnqA4xFCpvUgbGDJad7eS8WE,KwsfyHKRUTZPQtysN7M3tZ4GXTnuov5XRgjdF2XCG8faAPmFruRF,KzCUbGhN9LJhdeFfL9zQgTJMjqxdBKEekRGZX24hXdgCNCijkkap,KzgpMBwwsDLwkaC5UrmBgCYaBD2WgZ7PBoGYXR8KT7gCA9UTN5a3,KyBXTPy4T7YG4q9tcAM3LkvfRpD1ybHMvcJ2ehaWXaSqeGUxEdkP,KzJDe9iwJRPtKP2F2AoN6zBgzS7uiuAwhWCfGdNeYJ3PC1HNJ8M8,L1xbHrxynrqLKkoYc4qtoQPx6uy5qYXR5ZDYVYBSRmCV5piU3JG9,RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))","sh(multi(16,03669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0,0260b2003c386519fc9eadf2b5cf124dd8eea4c4e68d5e154050a9346ea98ce600,0362a74e399c39ed5593852a30147f2959b56bb827dfa3e60e464b02ccf87dc5e8,0261345b53de74a4d721ef877c255429961b7e43714171ac06168d7e08c542a8b8,02da72e8b46901a65d4374fe6315538d8f368557dda3a1dcf9ea903f3afe7314c8,0318c82dd0b53fd3a932d16e0ba9e278fcc937c582d5781be626ff16e201f72286,0297ccef1ef99f9d73dec9ad37476ddb232f1238aff877af19e72ba04493361009,02e502cfd5c3f972fe9a3e2a18827820638f96b6f347e54d63deb839011fd5765d,03e687710f0e3ebe81c1037074da939d409c0025f17eb86adb9427d28f0f7ae0e9,02c04d3a5274952acdbc76987f3184b346a483d43be40874624b29e3692c1df5af,02ed06e0f418b5b43a7ec01d1d7d27290fa15f75771cb69b642a51471c29c84acd,036d46073cbb9ffee90473f3da429abc8de7f8751199da44485682a989a4bebb24,02f5d1ff7c9029a80a4e36b9a5497027ef7f3e73384a4a94fbfe7c4e9164eec8bc,02e41deffd1b7cce11cde209a781adcffdabd1b91c0ba0375857a2bfd9302419f3,02d76625f7956a7fc505ab02556c23ee72d832f1bac391bcd2d3abce5710a13d06,0399eb0a5487515802dc14544cf10b3666623762fbed2ec38a3975716e2c29c232,02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", "Cannot have 17 keys in multisig; must have between 1 and 16 keys, inclusive"); // Cannot have more than 16 keys in a multisig

    // Check for invalid nesting of structures
    CheckUnparsable("sh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "sh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", "A function is needed within P2SH"); // P2SH needs a script, not a key
    CheckUnparsable("sh(combo(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "sh(combo(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", "Cannot have combo in non-top level"); // Old must be top level
    CheckUnparsable("wsh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)", "wsh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)", "A function is needed within P2WSH"); // P2WSH needs a script, not a key
    CheckUnparsable("wsh(wpkh(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT))", "wsh(wpkh(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c))", "Cannot have wpkh within wsh"); // Cannot embed witness inside witness
    CheckUnparsable("wsh(sh(pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)))", "wsh(sh(pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)))", "Cannot have sh in non-top level"); // Cannot embed P2SH inside P2WSH
    CheckUnparsable("sh(sh(pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)))", "sh(sh(pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)))", "Cannot have sh in non-top level"); // Cannot embed P2SH inside P2SH
    CheckUnparsable("wsh(wsh(pk(RjaKNpMhipPkKrUrhtBP6C6ZMAbHh1diGGEY9jX9WCQX34eacnGT)))", "wsh(wsh(pk(02a5e85e848c4107607d7b8522018d6dffa6b40aad853ae634f95cded666dd1d8c)))", "Cannot have wsh within wsh"); // Cannot embed P2WSH inside P2WSH

...
MAGIC_BYTES = {
    "mainnet": b"\xf7\x1d\xdc\x3d",   # mainnet
    "testnet": b"\xf7\x2d\xdc\x3d",   # testnet
    "regtest": b"\xf7\x4d\xdc\x3d",   # regtest
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, *, net, timeout_factor):
        ...
        logger.debug('Connecting to Zork Network Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for Zork Network Node with id: {}'.format(connect_id))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Zork Network Node.

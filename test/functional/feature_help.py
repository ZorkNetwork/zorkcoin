...
"""Verify that starting zorkcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zorkcoin with -h for help text")
        ...
        self.log.info("Start zorkcoin with -version for version information")
        ...
        self.log.info("Start zorkcoind with -fakearg to make sure it does not start")

...
class ChainstateWriteCrashTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        # long-running test
        self.base_args = ["-limitdescendantsize=0", "-maxmempool=0", "-rpcservertimeout=900", "-dbbatchsize=200000", "-vbparams=mweb:-2:0"]
        ...
        self.node3_args = ["-blockmaxweight=4000000", "-acceptnonstdtxn", "-vbparams=mweb:-2:0"]

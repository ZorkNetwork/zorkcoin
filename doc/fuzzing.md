# Fuzzing Zork Network Node using libFuzzer

## Quickstart guide

To quickly get started fuzzing Zork Network Node using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Zork Network Node repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Zork Network Node more robust.
...
with certain assembly code from Zork Network Node's code. See [developer notes on sanitizers](../doc/developer-notes.md#sanitizers)
...
# Fuzzing Zork Network Node using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Zork Network Node using [`afl-fuzz`](https://github.com/google/afl):

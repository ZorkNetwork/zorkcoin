# Support for Output Descriptors in Zork Network Node

Since Zork Network Node v0.17, there is support for Output Descriptors. This is a
...
- `pkh([d34db33f/44'/240079435'/0']xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKqhMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJvLJuZZvRcEL/1/*)` describes a set of P2PKH outputs, but additionally specifies that the specified xpub is a child of a master with fingerprint `d34db33f`, and derived using path `44'/240079435'/0'`.
...
- Segwit addresses (bech32, of the form `zork1...` for mainnet or `zorktest1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
change chain directly as `xpub.../44'/240079435'/0'/1/*` where `xpub...`
...
existing Zork Network Node wallets, a convenience function `combo` is
